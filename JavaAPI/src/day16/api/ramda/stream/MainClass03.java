...
public class MainClass03 {
	...
	public static void main(String[] args) {
		...
		System.out.println(r3.getAsDouble());
		...
		//list에서 50보단 큰 값만 중복없이 저장하는 새로운 리스트 생성
		List<Integer> newList3 = list.stream().sorted().distinct().filter(a -> a>50).collect(Collectors.toList());
		System.out.println(newList3.toString());
		
		
		System.out.println("======================================================================");
		IntStream.range(1, 10).forEach(a -> System.out.println(a));//미만까지 정수스트림 반환
		IntStream.rangeClosed(1, 10).forEach(a->System.out.println(a)); //이하까지 정수 스트림 반환
